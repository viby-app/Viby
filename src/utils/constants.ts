export const hebrewDictionary = {
  ...
  businessUpdated: "העסק התעדכן בהצלחה!",
  errorUpdatingBusiness: "שגיאה בעדכון העסק, נסה שוב מאוחר יותר.",
  errorCreatingBusiness: "שגיאה ביצירת העסק, נסה שוב מאוחר יותר.",
  successUploadingImage: "התמונות הועלו בהצלחה!",
