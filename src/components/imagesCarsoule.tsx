    ...
    <div className="relative h-full w-full">
      <div className="flex h-full w-full flex-row justify-center overflow-x-auto">
        {isImagesLoading || isBusinessLoading ? (
          <div className="skeleton h-full w-full animate-pulse rounded-md bg-gray-200" />
        ) : images?.length === 0 ? (
          <div className="skeleton h-full w-full rounded-md bg-gray-200" />
        ) : (
